...
function ViewMoreWindow(props: ViewMoreWindowProps) {
  return (
    <div className="absolute bottom-14 left-1/2 -translate-x-1/2 transform flex items-center gap-4 rounded-[16px] p-6 bg-slate-50 shadow-lg shadow-slate-500/50">
