...
export default function Home() {
  return (
    <>
      <main className="max-w-[85rem] mx-auto flex flex-col items-center px-4">
        <div className="h-screen w-full flex flex-col justify-center md:flex-row gap-6 items-center py-10">
          <div className="w-auto md:w-2/5">
            ...
            <div className="mt-10 flex justify-center gap-2">
              <span className="text-shadow-lg">by</span>{" "}
              <a href="https://bojuan.dev" target="_blank">
                <img
                  className="w-12 text-shadow-sm"
                  src="/bojuan-logo.svg"
                  alt="bojuan.dev"
                />
              </a>
        ...
        <section className="my-10 flex flex-col items-center gap-4">
          ...
          <p className="max-w-xl text-center text-gray-500">
            Descubre la esencia de cada etnia ecuatoriana de una manera profunda
            y respetuosa de sus tradiciones, su vestimenta, su arquitectura y su
      ...
      <footer className="bg-blue-600 text-white py-4 pb-12 md:pb-4 mt-12">
        <div className="max-w-[85rem] m-auto">

        <p className="text-white text-center">© 2025 bojuanDev</p>
        </div>
      </footer>
    </>
  );
